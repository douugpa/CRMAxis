        ...
        <div className="col-lg-4">
          <div className="card">
            ...
            <div className="card-body">
              ...
              <p>Até 50 clientes</p>
              <p>Sem suporte</p>
              <button className="btn btn-log btn-outline-primary">Começar Agora</button>
            </div>
          </div>
        </div>
        ...
        <div className="col-lg-4">
          <div className="card">
            ...
            <div className="card-body">
              ...
              <button className="btn btn-log btn-primary">Assinar Agora</button>
            </div>
          </div>
        </div>
        ...
        <div className="col-lg-4">
          <div className="card">
            ...
            <div className="card-body">
              ...
              <button className="btn btn-log btn-outline-primary">Assinar Agora</button>
            </div>
          </div>
        </div>
